        ...
        ZStack {
            ...
            VStack {
                ...
                Button ("Enviar") {
                    ...
                    for i in 0..<vm.arrayPerfis.count {
                        for j in 0..<vm.arrayPerfis[i].historico.count{
                            if vm.arrayPerfis[i].historico[j].id == profissionalSelecionado._id{
                                vm.arrayPerfis[i].historico[j].avaliacao = aval
                                vm.arrayPerfis[i].historico[j].comentario = coment
                            }
                        }
                    }
